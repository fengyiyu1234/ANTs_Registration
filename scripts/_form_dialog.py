...
per-script in scripts/.dialog_state/<script_name>.json (gitignored, so it
never shows up as a git diff).

Not runnable on its own -- imported by scripts/edit_sample_labels.py and
scripts/place_landmarks.py.
"""
import json
