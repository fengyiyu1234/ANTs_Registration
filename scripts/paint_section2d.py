...
Usage: python scripts/paint_section2d.py configs/my_sections.yaml SECTION_NAME --output-dir masks
...
from registration_ants import atlas_utils, config as config_mod, section2d, section_io, section_masks
