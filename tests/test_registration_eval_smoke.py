...
Same manual-assert style as tests/test_pipeline_smoke.py / test_new_features_smoke.py
...
about what's mounted at /data/... Run manually: `python tests/test_registration_eval_smoke.py`.
"""
import sys
...
def write_napari_points_csv(path, points_xyz_reversed_to_zyx):
    """Write a CSV in the exact format scripts/place_landmarks.py produces
